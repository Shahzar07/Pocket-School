...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Create courses and products here. Write the material, let ET turn it into every study format, then publish.',
    roles: ['teacher'],
  ...
  },
  {
    ...
    body: 'Programmes, subjects, units and lessons. ET can design a whole scheme of work, then you edit anything it proposes.',
    roles: ['admin', 'institution_admin'],
