    ...
    sections: [
        ...
        blocks: [
          { type: 'p', text: 'Poket School provides an AI-powered educational platform offering the following services:' },
          {
            ...
            items: [
              ...
              <><strong>Content Generator (Quill):</strong> An AI-powered tool for generating study materials including flashcards, quizzes, audio summaries, mind maps, and video lessons.</>,
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'Content generated by AI features (Ayla, Quill) in response to your inputs may be used by you for personal educational purposes. You may not resell, commercially reproduce, or publish AI-generated content as your own original work without appropriate attribution and verification.' },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            rows: [
              ...
              ['AI Interaction Data', 'Conversation transcripts with Ayla and Quill, AI-generated content requests, feedback and ratings', 'All users'],
        ...
        blocks: [
          {
            ...
            items: [
              ...
              'To power AI tutoring and generation features (Ayla and Quill).',
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', text: 'We do not sell your personal data. We share data with third parties only in the following circumstances:' },
          {
            type: 'ul',
            items: [
              <><strong>AI Model Providers:</strong> We use third-party AI infrastructure to power Ayla and Quill. Conversation data is transmitted subject to their data processing agreements. We do not permit AI providers to use student data for model training beyond what is necessary to provide the service.</>,
        ...
        blocks: [
          {
            ...
            rows: [
              ...
              ['AI Performance', 'Track interactions with Ayla and Quill to improve response quality and personalisation.', 'Yes'],
  ...
  /* ── 5. ACCEPTABLE USE POLICY ────────────────────────────── */
  {
    ...
    sections: [
        ...
        blocks: [
          { type: 'p', text: 'You must not use the Poket School platform to:' },
          {
            ...
            items: [
              ...
              'Use Ayla, Quill, or any AI feature to generate content that is harmful, defamatory, illegal, sexually explicit, or designed to deceive.',
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', text: 'When using Ayla, Quill, and any other AI-powered features, you must not:' },
          {
            type: 'ul',
            items: [
