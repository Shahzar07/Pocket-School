...
export default function ParentCommunications() {
  ...
  const load = async () => {
    ...
    // Build the list of teachers from each child's enrolled courses.
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                {teachers.length > 0 ? (
                  ...
                  <p className="text-sm text-muted-foreground">No teachers found yet — your child needs to be enrolled in a course first.</p>
                )}
              </div>
              <div className="space-y-1.5">
                <Label>Subject *</Label>
